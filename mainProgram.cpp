...
int main(void) {
	...
	string constr = "removed for security";
...
/*		// SQL
//find_customer
CREATE OR REPLACE PROCEDURE DBS311_203E14.find_customer(customer_id IN Number, found OUT Number) AS
...
//find_product
CREATE OR REPLACE PROCEDURE DBS311_203E14.find_product(product_id IN Number, price OUT products.prod_sell% TYPE) AS
...
//add_order
CREATE OR REPLACE PROCEDURE DBS311_203E14.add_order(customer_id IN Number, new_order_id OUT Number) AS
...
//add_orderline
CREATE OR REPLACE PROCEDURE DBS311_203E14.add_orderline(orderId IN orderlines.order_no% type, itemId IN orderlines.line_no% type, productId IN orderlines.prod_no% type, quantity IN orderlines.qty% type, price IN orderlines.price% type) AS
BEGIN
...
//example queries to find orders and orderlines from 2020
